...
export async function POST(request) {
  ...
  const mailOptions = {
    from: email,
    to: "dsquareventcentre@gmail.com", // Replace with your receiving email
    subject: "D Square Event Center Booking",
    html: `
    <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
      <h2 style="color: #fff;"> Booking : </h2>
      <p><strong>Client's Name:</strong> ${name}</p>
      <p><strong>Email Address:</strong> ${email}</p>
      <p><strong>Phone Number:</strong> ${phoneNumber}</p>
      <p><strong>Date of Event:</strong> ${
        formattedDate ? formattedDate : "Not provided"
      }</p>
